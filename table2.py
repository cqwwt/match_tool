...
#表格
    def initialize(self):
        ...
        # 重新设置表格区域的大小
        #self.tableWidget.setGeometry(QtCore.QRect(0, 0, 200, 200))
        # 将数据显示在表格中
    ...
    def save(self):
        ...
        self.df_2 = pd.read_excel(save_finalData + '/匹配表.xlsx')
        self.df_1 = pd.read_excel(save_finalData +'/原数据+修改列.xlsx')
        self.df_1["修改后数据"] = self.df_2["修改后数据"]

        self.df.to_excel(save_finalData + '/原数据+修改列.xlsx', index=False)
